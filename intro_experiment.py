...
params = parser.parse_args(args=[
    ...
    '--reload_model', "/home/310553058/odeformer/experiments/paper/exp_use_ft_decoder_False/checkpoint.pth",
    '--use_wandb', 'False',
    ...
    '--debug',
    '--eval_only', 'True',
    '--eval_dump_path', '/home/310553058/odeformer/eval',
    # '--from_pretrained', 'True',
    '--beam_size', '50',
    '--use_ft_decoder', 'False',
])
